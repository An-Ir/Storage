...
ALTER TABLE storage_feature
    ADD CONSTRAINT location_attributes_features
...
ALTER TABLE storage
    ADD CONSTRAINT location_details_type
        FOREIGN KEY (type_id)
            REFERENCES type (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE storage
    ADD CONSTRAINT location_details_user
        FOREIGN KEY (user_id)
            REFERENCES "user" (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE "order"
    ADD CONSTRAINT orders_customer_user
...
ALTER TABLE storage_feature
    ADD CONSTRAINT storage_feature_storage
        FOREIGN KEY (storage_id)
            REFERENCES storage (id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE storage
    ADD CONSTRAINT storage_location
